...
| <a name="input_additionals_managed_policy_arns"></a> [additionals\_managed\_policy\_arns](#input\_additionals\_managed\_policy\_arns) | List of managed policies to attach to the MWAA IAM role | `list` | `[]` | no |
| <a name="input_additionals_policy_documents"></a> [additionals\_policy\_documents](#input\_additionals\_policy\_documents) | List of JSON IAM policy documents to attach to the MWAA IAM role | `list` | `[]` | no |
