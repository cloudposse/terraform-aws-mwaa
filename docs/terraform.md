...
| <a name="input_airflow_configuration_options"></a> [airflow\_configuration\_options](#input\_airflow\_configuration\_options) | The airflow\_configuration\_options parameter specifies airflow override options. | `any` | n/a | yes |
...
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | VPC ID for the EKS cluster. Required if `create_security_group` is `true` | `string` | `null` | no |
...
| <a name="output_mwaa_environment_tags_all"></a> [mwaa\_environment\_tags\_all](#output\_mwaa\_environment\_tags\_all) | The Created At date of the MWAA Environment |
